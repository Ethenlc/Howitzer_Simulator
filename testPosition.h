...
private:
    ...
    {
        // setup
        double metersFromPixels1 = Position::metersFromPixels;
        double metersFromPixels2 = Position::metersFromPixels;
        Position::metersFromPixels = 99.9;
        Position pos1;
        Position pos2;
        pos2.metersFromPixels = 123.4;
        ...
        // teardown
        Position::metersFromPixels = metersFromPixels2;
    }
