...
private:
    ...
    void linearInterpolation_coordinatesZero() {
        Mapping mapping[] = { {0.0, 0.0}, {1.0, 1.0}, {2.0, 2.0} };
        int numMapping = 3;
        double domain = 0.0;
        double expected = 0.0;
        assertUnit(linearInterpolation(mapping, numMapping, domain) == expected);
    }
    ...
    void linearInterpolation_coordinatesBackwards() {
        Mapping mapping[] = { {0.0, 0.0}, {2.0, 2.0}, {4.0, 4.0} };
        int numMapping = 3;
        double domain = 3.0;
        double expected = 3.0;
        assertUnit(linearInterpolation(mapping, numMapping, domain) == expected);
    ...
    void linearInterpolation_mappingTwo() {
        ...
        double result = linearInterpolation(mapping, numMapping, domain);
        assertEquals(result, expectedRange);
    }
    ...
    void linearInterpolation_mappingMid01() {
        ...
        int numMapping = 4;
        double domain = 2.0;
        double expectedRange = 2.5;  // Expected value derived from manual calculation
        double result = linearInterpolation(mapping, numMapping, domain);
        assertEquals(result, expectedRange);
    }
    ...
    void linearInterpolation_mappingTop01() {
        ...
        int numMapping = 4;
        double domain = 2.8;
        double expectedRange = 2.9;  // Expected value derived from manual calculation
        double result = linearInterpolation(mapping, numMapping, domain);
        assertEquals(result, expectedRange);
    }
    ...
    void linearInterpolation_mappinglower23() {
        ...
        int numMapping = 4;
        double domain = 7.33333333;  // Approximate value
        double expectedRange = 5.5;  // Expected value derived from manual calculation
        double result = linearInterpolation(mapping, numMapping, domain);
        assertEquals(result, expectedRange);
    }
    ...
    void linearInterpolation_mappingSmall() {
        ...
        int numMapping = 4;
        double domain = 0.2;
        double expectedRange = 2.0;  // Extrapolated value from the nearest domain
        double result = linearInterpolation(mapping, numMapping, domain);
        assertEquals(result, expectedRange);
    }
    ...
    void linearInterpolation_mappingLarge() {
        ...
        int numMapping = 4;
        double domain = 50.0;
        double expectedRange = 6.5;  // Extrapolated value from the nearest domain
        double result = linearInterpolation(mapping, numMapping, domain);
        assertEquals(result, expectedRange);
    }
    ...
    void gravityFromAltitude_5500()
    {
        ...
        assert(fabs(gravity - 9.7895) < tolerance);
    }
    /*******************************************************
    ...
    ********************************************************/
    void gravityFromAltitude_43333()
    {
        ...
        assert(fabs(gravity - 9.674) < tolerance);
    }
    ...
    void gravityFromAltitude_3666()
    {
        ...
        assert(fabs(gravity - 9.795) < tolerance);
    }
    ...
    void gravityFromAltitude_8848()
    {
        ...
        assert(fabs(gravity - 9.77945) < tolerance);
    }
    ...
    void speedSoundFromAltitude_0()
    {
        ...
        double speed = speedSoundFromAltitude(altitude);
        assertEquals(altitude, 0.0);
    ...
    void speedSoundFromAltitude_3666()
    {
        ...
        double expectedSpeed = 325.67;

        double speed = speedSoundFromAltitude(altitude);
        // round to one decimal place
        speed = std::round(speed * 10.0) / 10.0;

        assertEquals(altitude, 3666.0);
        assertEquals(speed, 325.7);
    }
    /*******************************************************
    ...
    void dragFromMach_500()
    {
        ...
        // round
        drag = std::round(drag * 10000.0) / 10000.0;

        // verify
        assertEquals(speedMach, 5.0);
        assertEquals(drag, 0.2656); // Adjust based on expected rounded value
    }
